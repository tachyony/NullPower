 ...
 * Ender generator
 */
public class TileEntityEnderGenerator2 extends TileEntity implements IEnergyHandler {
	private BasicSource ic2EnergySource = new BasicSource(this, 2048, 2);
	...
	public void updateEntity() {
        ...
        {
        	this.ic2EnergySource.addEnergy(50);
        }
    }
